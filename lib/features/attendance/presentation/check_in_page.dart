...
class _CheckInPageState extends ConsumerState<CheckInPage> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: Icon(
                _isLocating ? Icons.location_searching : (_isWithinRange ? Icons.check : Icons.location_off),
                size: 48,
                color: _isWithinRange ? const Color(0xFF10B981) : const Color(0xFF9CA3AF),
              ),
            ),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  child: _isSubmitting
                      ...
                      : const Text('تسجيل الحضور', style: TextStyle(fontSize: 18)),
                ),
              ),
  ...
  Future<void> _checkIn() async {
    ...
    final response = await ref.read(attendanceRepositoryProvider).checkin(
      CheckinRequest(
    ...
    if (mounted) {
      ...
      if (response.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(response.error?.message ?? 'فشل تسجيل الحضور')),
        );
      }
    }
  }
