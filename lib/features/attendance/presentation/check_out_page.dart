...
class _CheckOutPageState extends ConsumerState<CheckOutPage> {
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.logout, size: 48, color: Color(0xFFEF4444)),
            ),
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                child: _isSubmitting
                    ...
                    : const Text('تأكيد الانصراف', style: TextStyle(fontSize: 18)),
              ),
            ),
  ...
  Future<void> _checkOut() async {
    ...
    final response = await ref.read(attendanceRepositoryProvider).checkout(
      CheckinRequest(
        latitude: 32.8872,
        longitude: 13.1911,
        accuracy: 10,
    ...
    if (mounted) {
      ...
      if (response.success) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text(response.error?.message ?? 'فشل تسجيل الانصراف')),
        );
      }
    }
  }
